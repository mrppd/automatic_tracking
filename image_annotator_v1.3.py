...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ptsTable.verticalHeader().setVisible(True)
        self.ptsTable.verticalHeader().setCascadingSectionResizes(False)
        self.ptsTable.verticalHeader().setDefaultSectionSize(25)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Image Annotator (Version 1.3)"))
